...
|----------|-------|--------|
| HIGH     | 6 (Android) + 2 (Worker) = 8 | Pending |
...
1. A1 - EncryptedSharedPreferences for tokens
2. A2/A3/A7 - Gate all logging behind BuildConfig.DEBUG
3. A4 - Secure the ContentProvider
4. A5 - Set usesCleartextTraffic=false
5. A6 - Set allowBackup=false
6. W1 - Add auth/origin check to token proxy
...
9. W2 - Add OAuth state parameter
